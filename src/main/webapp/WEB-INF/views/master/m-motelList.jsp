...
<main id="main">
	<div class="containerBox">
		...
		<div class="container" style="padding: 20px; margin-left: 800px; margin-top: 130px;">
				<div class="button" style="margin-bottom: 20px;margin-left: 600px"><a href="/master/detail"><button>입력</button></div></a>
			<a href="/detail">
			...
			<a href="/master/detail"><button>수정</button></a><button>삭제</button>
		</div>
